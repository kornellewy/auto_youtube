from moviepy import TextClip, ImageClip, VideoClip, CompositeVideoClip, vfx
...
def create_text(
    ...
    arg_hash = hash((text, fontsize, color, font, bg_color, blur_radius, opacity, stroke_color, stroke_width))
    ...
    # text_clip = text_clip.add_mask()
    # text_clip = text_clip.set_mask(text_clip.mask.fx(vfx.multiply_color, float(opacity)))
